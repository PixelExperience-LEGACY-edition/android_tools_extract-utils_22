...
binaries_dir = path.join(android_root, 'prebuilts/extract-tools_22/linux-x86/bin')
...
common_binaries_dir = path.join(android_root, 'prebuilts/extract-tools_22/common')
